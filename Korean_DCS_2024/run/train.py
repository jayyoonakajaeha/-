...
# fmt: off
parser = argparse.ArgumentParser(prog="train", description="Training about Daily Conversation Summarization.")
...
def main(args):
    ...
    #model.print_trainable_parameters()  # 학습 가능한 파라미터 출력 (디버깅용)
